      ...
      <div class="sidebar" id="notifications">
        <div class="sidebar-header d-block align-items-end">
          ...
          <ul class="nav nav-pills">
            <li class="nav-item">
              <a
                class="nav-link active nav-link-notify"
                data-bs-toggle="tab"
                href="#activities"
              >
                Activities
      ...
      <div class="menu">
        ...
        <div class="menu-body">
          ...
          <ul>
            ...
            <li>
              <a :class="[address=='Home'?'active':'','']" href="/Home">
            ...
            <li>
              <a
                href="/Customers"
               :class="[address=='Customers'?'active':'','']"
              >
                <span class="nav-link-icon">
            ...
            <li>
              <a
                href="/Categories"
               :class="[address=='Categories'?'active':'','']"
              >
                <span class="nav-link-icon">
                  <i class="bi bi-receipt"></i>
                </span>
