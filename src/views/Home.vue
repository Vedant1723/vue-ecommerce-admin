...
<SidebarVue address="Home"/>
      <div class="layout-wrapper">
              ...
              <div class="card widget h-100">
                <div class="card-header d-flex">
                  <h6 class="card-title">
                    ...
                    <a
                      href="#"
                      class="bi bi-question-circle ms-1 small"
                ...
                <div class="card-body">
                  ...
                  <div class="summary-cards">
                    ...
                    <div>
                      <div class="d-flex align-items-center mb-3">
                        <div class="avatar me-3">
                          <span class="avatar-text bg-indigo rounded-circle">
                            J
                          </span>
                        </div>
                        <div>
                    ...
                    <div>
                      <div class="d-flex align-items-center mb-3">
                        <div class="avatar me-3">
                          <span class="avatar-text bg-yellow rounded-circle">
                            D
                          </span>
                        </div>
                        <div>
                    ...
                    <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                      <div class="d-flex flex-grow-1 align-items-center">
                        <img
                          width="45"
                          class="me-3"
                          src="https://vetra.laborasyon.com/assets/flags/venezuela.svg"
                          alt="..."
                        />
                        <span>Venezuela</span>
                      </div>
                    ...
                    <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                      <div class="d-flex flex-grow-1 align-items-center">
                        <img
                          width="45"
                          class="me-3"
                          src="https://vetra.laborasyon.com/assets/flags/salvador.svg"
                          alt="..."
                        />
                        <span>Salvador</span>
                      </div>
                    ...
                    <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                      <div class="d-flex flex-grow-1 align-items-center">
                        <img
                          width="45"
                          class="me-3"
                          src="https://vetra.laborasyon.com/assets/flags/russia.svg"
                          alt="..."
                        />
                        <span>Russia</span>
                      </div>
        ...
        <footer class="content-footer">
          <div>
            © 2021 Vetra -
            <a href="https://laborasyon.com/" target="_blank">
              Laborasyon
            </a>
          </div>
          <div>
